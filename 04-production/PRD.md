...
| 4 | Follow-up creation and detail screen | Must | Priority: Must have Acceptance criteria: Creating a follow-up on the recommendation screen navigates to /follow-up and records the follow_up_created event. The follow-up screen shows title, owner, due date, linked recommendation, status (Planned / In review), metric to move, target, and step checklist. When no follow-up exists, /follow-up shows an empty state with a link to the recommendation. |
